...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Cargo__3214EC0786E83ED6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Comentar__3214EC07359C5C20");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Forum__3214EC078D2CF197");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ImageDat__3214EC27A67D1C51");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Permissa__3214EC0710BD222E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Post__3214EC07AACD1DE6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Usuario__3214EC07A7698C09");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UsuarioC__3214EC077C6F87BB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UsuarioF__3214EC072CB44DC4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Vote__3214EC07682DDC31");

            entity.ToTable("Vote");

            entity.HasOne(d => d.IdPostNavigation).WithMany(p => p.VotesNavigation)
                .HasForeignKey(d => d.IdPost)
                .OnDelete(DeleteBehavior.ClientSetNull)
